...
const reducer = createReducer(
    ...
    on(StarshipActions.storeStarshipsAmount, (state, action): StarshipState => ({ ...state, allStarships: action.p })),
    on(StarshipActions.throwStarshipsAmount, (state): StarshipState => ({ ...state, allStarships: 0 })),
