...
export const storeStarshipsAmount = createAction('[STARSHIPS] store pages', props<{ p: number }>())
export const throwStarshipsAmount = createAction('[STARSHIPS] throw pages')
